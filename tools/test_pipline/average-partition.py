...
# Root directories
root_image_dir = '/nas/datasets/lzy/RS-ChangeDetection/Figures/Average'
root_checkpoint_dir = '/nas/datasets/lzy/RS-ChangeDetection/Best_ckpt'
root_output_dir = '/nas/datasets/lzy/RS-ChangeDetection/Figures/Average-Partition'
...
def process_model(model_name, model_checkpoint_path):
    # label_image_dir = os.path.join(root_image_dir, 'vis_image')  # Update to use new image directory
    label_image_dir = root_image_dir
...
if __name__ == '__main__':
    models_to_run = ["CGNet"]  # List of models to process
    main(models_to_run)
