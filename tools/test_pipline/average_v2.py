...
root_folder = "/nas/datasets/lzy/RS-ChangeDetection/Figures/VAL"
best_output_folder = os.path.join(root_folder, "Average/Average-new")

# 定义需要处理的模型子文件夹名称
model_folders = [
    
    "Extended/Single/TTP/vis_data/vis_image",
    "Extended/Single/Changer-mit-b1/vis_data/vis_image",

    "Single-Partition/TTP/final/vis_data/vis_image",
    "Single-Partition/Changer-mit-b1/final/vis_data/vis_image",
    
    "Extended/Single-Partition/TTP/final/vis_data/vis_image",
    "Extended/Single-Partition/Changer-mit-b1/final/vis_data/vis_image",
    
    "Extended-Selected/Single/TTP/vis_data/vis_image",
    "Extended-Selected/Single/Changer-mit-b1/vis_data/vis_image",

    "Average/Average-82.16",
    "Average/Average-82.012",
    "Average/Average-81.189",
    "Average/Average-80.94"


]

# 定义每个文件夹中图片的数量
image_count = 100  # 根据你的数据集的大小设置
        ...
        for i in range(1, image_count + 1):
            ...
            for model in combination:
                ...
                if 'Extended' in model:
                    image_path = os.path.join(vis_image_folder, f"CGWX_image_{i}.png")
                else:
