...
root_folder = "/nas/datasets/lzy/RS-ChangeDetection/Figures/TEST/Single"
best_output_folder = "/nas/datasets/lzy/RS-ChangeDetection/Figures/TEST/Average"

# 定义需要处理的模型子文件夹名称
model_folders = ["TTP", "Changer-mit-b1", "CGNet", "BAN-vit-b16-int21k-mit-b2"]
suffix = "vis_data/vis_image"

# 定义每个文件夹中图片的数量
image_count = 100  # 根据你数据集的大小设置
    ...
    for combination in itertools.combinations(model_folders, r):
        ...
        for i in range(1, image_count + 1):
            ...
            for model in combination:
                vis_image_folder = os.path.join(root_folder, model, suffix)
