...
# Root directories
root_image_dir = '/nas/datasets/lzy/RS-ChangeDetection/Figures/Single/Extended'
root_checkpoint_dir = '/nas/datasets/lzy/RS-ChangeDetection/Best_ckpt_3'
root_output_dir = '/nas/datasets/lzy/RS-ChangeDetection/Figures/Single-Partition/Extended'
gt_folder = '/nas/datasets/lzy/RS-ChangeDetection/CGWX-Extended/test/label'
test_dir = '/nas/datasets/lzy/RS-ChangeDetection/CGWX-Extended/test'
test_s_dir = '/nas/datasets/lzy/RS-ChangeDetection/CGWX-Extended/test_s'
test_m_dir = '/nas/datasets/lzy/RS-ChangeDetection/CGWX-Extended/test_m'
test_l_dir = '/nas/datasets/lzy/RS-ChangeDetection/CGWX-Extended/test_l'
...
if __name__ == '__main__':
    models_to_run = ["Changer-mit-b1"]  # List of models to process
    main(models_to_run)
