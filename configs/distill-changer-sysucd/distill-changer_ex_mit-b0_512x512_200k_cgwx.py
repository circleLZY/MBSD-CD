_base_ = [
    '../_base_/models/Self-KD-changer_mit-b0.py', 
    '../common/standard_512x512_200k_cgwx-sysucd.py']

dataset_type = 'LEVIR_CD_Dataset'
data_root = '/nas/datasets/lzy/RS-ChangeDetection/Benchmarks/SYSU-CD'

crop_size = (256, 256)

checkpoint_student = '/nas/datasets/lzy/RS-ChangeDetection/checkpoints_self_distill/SYSU-CD/Changer-mit-b0/Initial/best_mIoU_iter_1000.pth'
checkpoint_teacher_l = '/nas/datasets/lzy/RS-ChangeDetection/checkpoints_self_distill/SYSU-CD/Changer-mit-b0/Initial/best_mIoU_iter_1000.pth'
checkpoint_teacher_s = '/nas/datasets/lzy/RS-ChangeDetection/checkpoints_self_distill/SYSU-CD/Changer-mit-b0/Initial/best_mIoU_iter_1000.pth'
